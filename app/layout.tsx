...
export const metadata: Metadata = {
  ...
  description:
    "Abu Dhabi's best curtain shop. Buy premium custom curtains, blackout curtains, roller blinds, and motorized blinds for villas, hotels, and offices. Thousands of fabrics. Free design visit. Installation in 3 days. 3-year warranty.",
  keywords: [
    "curtains Abu Dhabi",
    ...
    "buy curtains Abu Dhabi",
    "villa curtains Abu Dhabi",
    "motorized curtains",
    "blackout curtains Abu Dhabi",
    "curtain installation Abu Dhabi",
    "curtain fabrics Abu Dhabi",
    "custom curtains UAE",
    "curtain design visit",
    "roller blinds Dubai",
    "abaya curtains Dubai",
  ],
  openGraph: {
    title: "Curtain Makers | Premium Curtains & Blinds",
    description:
      "Abu Dhabi's premier curtain and blinds specialist. Thousands of curtain fabrics, in-house manufacturing, free design visit, and 3-day installation.",
